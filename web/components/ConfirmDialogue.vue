<template>
  <teleport to="body">
    <div
      ...
      id="deleteModal"
      tabindex="-1"
      class="overflow-y-auto overflow-x-hidden flex h-full fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full bg-black/[.5]"
    >
