...
<div class="lg:hidden mb-3">
    <button type="button" onclick="openCardModal()" class="w-full inline-flex items-center justify-center gap-1.5 px-2 py-2 rounded-lg border border-border text-sm text-dark hover:bg-dark/5 active:scale-95 transition" title="Nueva tarjeta">
...
<div class="card !p-4" id="cards-carousel-card">
    ...
    <div class="mt-4 pt-4 border-t border-border flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex items-center gap-3">
            ...
            <button id="card-info-edit"   type="button" class="btn btn-ghost text-xs px-3 py-2 sm:px-2 sm:py-1">Editar</button>
            <button id="card-info-delete" type="button" class="btn btn-ghost text-xs px-3 py-2 sm:px-2 sm:py-1 text-danger hover:text-danger">Eliminar</button>
        </div>
    </div>
...
<!-- ─────────────────────────── Form modal ─────────────────────────── -->
<div id="card-modal" class="fixed inset-0 z-50 hidden bg-dark/40" data-bs-modal="closeCardModal">
    ...
    <div class="absolute inset-x-0 bottom-0 sm:inset-0 sm:flex sm:items-center sm:justify-center sm:p-4"
        ...
        <div class="bg-white rounded-t-2xl sm:rounded-xl border-t sm:border border-border w-full sm:max-w-md max-h-sheet overflow-y-auto safe-bottom">
            ...
            <button type="button" onclick="closeCardModal()" class="w-full pt-2 pb-1 flex justify-center sm:hidden" aria-label="Cerrar">
...
<!-- ─────────────────────────── Confirm delete ─────────────────────────── -->
<div id="card-delete-modal" class="fixed inset-0 z-50 hidden bg-dark/40" data-bs-modal="closeCardDelete">
    <div class="absolute inset-x-0 bottom-0 sm:inset-0 sm:flex sm:items-center sm:justify-center sm:p-4"
         style="bottom: var(--keyboard-inset, 0px);">
        <div class="bg-white rounded-t-2xl sm:rounded-xl border-t sm:border border-border w-full sm:max-w-sm safe-bottom">
            <!-- Drag handle (mobile only, tap to close) -->
            <button type="button" onclick="closeCardDelete()" class="w-full pt-2 pb-1 flex justify-center sm:hidden" aria-label="Cerrar">
                <div class="w-10 h-1 rounded-full bg-border"></div>
            </button>
            <div class="p-5">
