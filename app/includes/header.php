    ...
    <aside id="sidebar" class="fixed lg:sticky top-0 left-0 z-40 h-screen w-60 bg-white border-r border-border flex flex-col
        ...
        <nav class="flex-1 p-3 space-y-1">
            ...
            $navItems = [
                ...
                ['/capturar', 'Capturar', '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-6.857 2.286L12 21l-2.286-6.857L3 12l6.857-2.286L12 3z"/>'],
