...
// NOTE: when adding a route here, mirror it in $moreItems in footer.php
// (and update the "Más" active-route check). The two lists are not auto-
// derived — desktop sidebar reads from here, mobile bottom-sheet reads there.
$secondaryNav = [
